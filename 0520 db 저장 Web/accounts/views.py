...
def signup_hate(request):
    if request.method == 'POST':
        ...
        # print(target_ing_objs.query)
        # b = Ingredient.objects.all()
        # print(b[0])
        # print(b[0].ingredients)
        # # print()
        # print(type(b[0].ingredients))
        # print(len(b[0].ingredients))
        # a = Ingredient.objects.filter(ingredients="다시마육수").all()
        # print(a)
        # print(ingrement_list)
        # print(target_ing_objs)
